    ...
    >
      <div className="mx-auto max-w-screen-2xl">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={inView}
          transition={{ ...easeOut, delay: omitHeaderContent ? 0.06 : 0.1 }}
          className={
            omitHeaderContent
              ? "grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 lg:items-start"
              : "mt-16 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 lg:items-start"
          }
        >
          <div>
