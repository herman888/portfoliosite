...
const sportsLabel = site.person.interests.sports
		...
		<div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between bg-transparent py-16 px-4 gap-12">
			...
			<div className="flex-shrink-0 flex flex-col items-center">
				...
				<div className="flex space-x-3 mt-2">
					<a href={site.links.github} target="_blank" rel="noopener noreferrer" className="bg-[#d6c9a5] p-2 rounded-full text-gray-700 hover:bg-[#e5e5c0] transition">
					...
					<a href={site.links.linkedIn} target="_blank" rel="noopener noreferrer" className="bg-[#d6c9a5] p-2 rounded-full text-gray-700 hover:bg-[#e5e5c0] transition">
					...
					<a href={`mailto:${site.links.email}`} className="bg-[#d6c9a5] p-2 rounded-full text-gray-700 hover:bg-[#e5e5c0] transition">
			...
			<div className="flex-1 flex flex-col items-start max-w-xl">
				...
				<h2 className="text-lg text-gray-700 mb-4">{site.person.roleLine}</h2>
				...
				<ul className="mb-4 text-gray-700">
					{profilePastItems.map((b) => (
						<li key={b.kind === 'intern' ? b.org : b.topic}>
							{b.kind === 'intern' ? (
								<>
									Interned @ <b>{b.org}</b>: {b.detail}
								</>
							) : (
								<>
									Researched <b>{b.topic}</b> @ {b.institution}
								</>
							)}
						</li>
					))}
